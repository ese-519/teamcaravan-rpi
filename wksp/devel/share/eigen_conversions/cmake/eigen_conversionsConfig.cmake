...
if("TRUE" STREQUAL "TRUE")
  set(eigen_conversions_SOURCE_PREFIX /home/ubuntu/hemo_code/new_code/wksp/src/geometry/eigen_conversions)
  set(eigen_conversions_DEVEL_PREFIX /home/ubuntu/hemo_code/new_code/wksp/devel)
  ...
  set(eigen_conversions_INSTALL_PREFIX /home/ubuntu/hemo_code/new_code/wksp/install)
...
if(NOT "/home/ubuntu/hemo_code/new_code/wksp/src/geometry/eigen_conversions/include;/usr/include/eigen3;/opt/ros/indigo/include " STREQUAL " ")
  set(eigen_conversions_INCLUDE_DIRS "")
  set(_include_dirs "/home/ubuntu/hemo_code/new_code/wksp/src/geometry/eigen_conversions/include;/usr/include/eigen3;/opt/ros/indigo/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'eigen_conversions' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/ubuntu/hemo_code/new_code/wksp/src/geometry/eigen_conversions/${idir}'.  Ask the maintainer 'Tully Foote <tfoote@osrfoundation.org>' to fix it.")
    endif()

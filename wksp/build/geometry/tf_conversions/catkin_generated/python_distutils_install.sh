...
cd "/home/ubuntu/hemo_code/new_code/wksp/src/geometry/tf_conversions"
...
/usr/bin/env \
    ...
    "/usr/bin/python" \
    "/home/ubuntu/hemo_code/new_code/wksp/src/geometry/tf_conversions/setup.py" \
    build --build-base "/home/ubuntu/hemo_code/new_code/wksp/build/geometry/tf_conversions" \
    install \
    $DESTDIR_ARG \
